...
pub(super) fn log_render_asset_pressure(
    ...
    let (
        fluid_settling_active,
        fluid_settling_generated,
        fluid_settling_mutable,
        fluid_settling_initialization,
        fluid_settling_work,
        fluid_settling_verification,
        fluid_settling_verification_chunks,
    ) = assets.streaming.diagnostic_fluid_settling_counts();
