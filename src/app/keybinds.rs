...
impl KeybindAction {
    ...
    pub(crate) const fn localization_key(self) -> &'static str {
        match self {
            ...
            Self::CharacterInfo => "settings.keybind.characterInfo",
...
impl Default for Keybinds {
    fn default() -> Self {
        Self {
            ...
            character_info: KeyboardKey::KeyC,
...
impl Keybinds {
    pub(crate) const fn key(self, action: KeybindAction) -> KeyboardKey {
        match action {
            ...
            KeybindAction::CharacterInfo => self.character_info,
    ...
    pub(crate) fn set(
        ...
        match action {
            ...
            KeybindAction::CharacterInfo => self.character_info = key,
