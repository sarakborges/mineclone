...
**HEAD de código mais recente:** `a1d3fde8f9856e0a56609e1eedab8b4a96aceb56` (`river/selection.rs`: não poluir cache ao atingir trace limit). Bump `754973c2325dc1acb0142a062805c126ede616a9`. `VERSION = 0.15.20`. Este commit de documentação não sobe versão; reconsultar HEAD/VERSION antes de próximas mudanças.

**CI confirmado para 0.15.3–0.15.18 (Clippy + Check):** 0.15.3 run35054771262; 0.15.4 #2064; .5 #2066; .6 #2068; .7 #2070; .8 #2075; .9 #2078; .10 #2080; .11 #2082; .12 #2084; .13 run35109440316; .14 run35111512775; .15 run35112785390; .16 run35112964210; .17 run35113608338; .18 run35114063244. **0.15.19 último código `9044a40` run35116468021 em andamento; 0.15.20 bump `754973c` run35116860460 em andamento** na última consulta. Atualizar statuses reais ao concluir. Clippy/check não executam unit tests/gameplay.
...
| P0.2 chunks inteiramente escuros/sombras tardias | Aberto visualmente, fix seed única 0.15.17 CI aprovado | Verificar convergência, halo/revisions, remesh; FPS |
...
| P0.4 rios sem ligação com lago/oceano | Aberto visualmente; patches 0.15.15/.16/.19/.20 | Continuidade física em seed real, cross-region, ocean outlet, confluência |
...
| P1 antigo streaming/Coast/nuvens | Usuário informou `1 feito` | Preservar; reabrir apenas evidência |
...
Ordem: preservar FPS e P0.5. Confirmar CI .19/.20; validar rio real e luz, depois P0.3, P0.6/7 e R. Não encerrar bug visual com CI apenas.
...
1. Confirmar CI runs 35116468021 (0.15.19) e 35116860460 (0.15.20), corrigindo warnings/errors concretos; CI não roda testes unitários e não comprova gameplay.
...
5. P0.6: medir seleção real versus semelhança visual; P0.7: CurrentBiome->EnvironmentVisualState->ClearColor e fog artística com terminal igual sky.
